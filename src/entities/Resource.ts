...
export enum ResourceType {
  ...
  course = 'course',
  podcast = 'podcast', // migrate
  podcast_series = 'podcast_series', // to remove
  podcast_episode = 'podcast_episode', // new
  youtube_video = 'youtube_video',
  youtube_video_series = 'youtube_video_series', // to remove
  youtube_playlist = 'youtube_playlist', // new
  online_book = 'online_book', // new
  book = 'book',
