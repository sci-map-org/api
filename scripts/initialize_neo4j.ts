...
// CALL db.index.fulltext.createNodeIndex("namesAndDescription",["Topic", "LearningGoal", "Resource", "LearningPath"],["name", "key", "description", "type", "topicType"])
...
// CREATE CONSTRAINT unique_resource_ids ON (n:Resource) ASSERT n._id IS UNIQUE
// CREATE CONSTRAINT unique_learning_paths_ids ON (n:LearningPath) ASSERT n._id IS UNIQUE
